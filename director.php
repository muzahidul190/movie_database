...
$dir_id = $_GET['director_id'];
if (!isset($dir_id)) {
    header("location:index.php");
}

$sql = "SELECT * FROM director WHERE director_id = $dir_id";
$row = mysqli_fetch_assoc(mysqli_query($conn, $sql));

$title = $row['director_first_name'] . " " . $row['director_last_name'] . " | ";    //Need to update title
...
<div class="row">
    <div class="col-12 col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <h4 class="card-title"><a class="link-success text-decoration-none" href="#"><?php echo $row['director_first_name'] . " " . $row['director_last_name']; ?></a></h4>
            </div>
        </div>
    </div>
    <div class="col-12 col-md-6">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"><small>More about </small><?php echo $row['director_first_name'] . " " . $row['director_last_name']; ?></h4>
...
<div class="card">
    <div class="card-body">
        <div class="card-title">
            <h4>Movies Directed by <?php echo $row['director_first_name'] . " " . $row['director_last_name']; ?></h4>
        </div>
    </div>
</div>
...
<div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
    <?php
    $sqlmov = "SELECT movie_id FROM movie_direction WHERE director_id = $dir_id";
